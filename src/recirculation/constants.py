...
EXPLORATORY_SELECTION_ID = "exploratory_books_0_1_v1"
EXPLORATORY_START_DOCUMENT = 0
CONFIRMATORY_SELECTION_ID = "confirmatory_unseen_books_2_9_v1"
CONFIRMATORY_START_DOCUMENT = 2
CONFIRMATORY_NUM_DOCUMENTS = 8
